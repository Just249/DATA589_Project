...
But as the origin dataset contains about 60K occurrences, the whole dataset takes a tremendous amount of time (4 hours just to load the complete set of data from gbif api!) to load and analyze the data. After consulting the course instructor, we have set the limit to 2000 records with the gbif api.
