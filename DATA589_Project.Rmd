...
A total of about 80,000 occurrences records are available, which are consolidated from a total of 109 datasets.  However, the following three major parties constitute about 85% of the total occurrences records :

- UBC Herbarium - Licen Collection
- iNaturalist Research-grade Observations
- Assembly and activity of microbial communities in the Pacific temperate rainforest

...describe the data cols, data cleaning, data selection....
...
what stat packages are used...

## 2.3 Analytical Workflow 
First EDA, then 1st moment analysis, then 2nd moment analysis steps 
...
### 2.3.2 Spatial Dataset Conversion and Preparation
...
### 2.3.3 EDA : BC Windows and Covariates Data Walkthough
...
### 2.3.5 First Moment Descriptive Statistics
...
#### 2.3.6.d Covariate Variable Observation
